...
def convbn_3d(in_planes, out_planes, kernel_size, stride, pad):
    ...
    return nn.Sequential(nn.Conv3d(in_planes, out_planes, kernel_size=kernel_size, padding=pad, 
        stride=stride, bias=False), nn.BatchNorm3d(out_planes))
...
class feature_extraction(nn.Module):
    ...
    def forward(self, x):
        ...
        # updated by CCJ dut to possibly deprecated warning:
...
# Added by CCJ: for Using Python Inheritance:
