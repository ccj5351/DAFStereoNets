# !/usr/bin/env python3
# -*-coding:utf-8-*-
# @file: input_preprocess.py
# @brief:
# @version: 0.0.1
# @creation date: 05-03-2019
# @last modified: Thu 21 Mar 2019 04:49:24 PM EDT
...
from src import preprocess_utils
...
def preprocess_image_and_label(image,
  ...
  #print('??? target_height = {}'.format(target_height))

  # Pad image with mean pixel value.
  #mean_pixel = tf.reshape( feature_extractor.mean_pixel(model_variant), [1, 1, 3])
  mean_pixel = tf.reshape(preprocess_utils.mean_pixel(model_variant), [1, 1, 3])
