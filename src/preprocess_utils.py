...
# @last modified: Wed 13 Mar 2019 05:49:54 PM EDT
...
def pad_to_bounding_box(image, offset_height, offset_width, target_height,
  ...
  #NOTE:????
  """added by CCJ """
  #image = tf.Print(input_ = image, data = [tf.shape(image),], message = "[*****] image", first_n = 1, summarize = 3)
  ...
  #print 'after_padding_heigh = ', after_padding_height
  #offset_height = tf.Print(input_ = offset_height, data = [tf.shape(offset_height),], message = "[*****] offset_height", first_n = 1, summarize = 3)
...
""" The following functions are previously provided in deeplab/core/feature_extractor.py file """
