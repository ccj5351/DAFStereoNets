...
#CURRENT_DIR=$(pwd)
WORK_DIR="/media/ccjData2/datasets/pascal_voc_seg"
#WORK_DIR="/home/ccj/seg-depth/datasets/pascal_voc_seg"
#cd "${WORK_DIR}"
...
#LIST_FOLDER="${PASCAL_ROOT}/ImageSets/Segmentation-small"
